...
<nav class="flex" aria-label="Breadcrumb">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="{{ url('history')}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Histori Pesanan</a>
      </div>
    </li>
    </ol>
    </nav>
